...
cp -p $HOME/.bashrc $DIR_DROPBOX/bash/.bashrc_forbush
cp -p $HOME/.zshrc $DIR_DROPBOX/bash/.zshrc_forbush
cp -p $ZSH_CUSTOM/alias.zsh $DIR_DROPBOX/bash/alias_forbush.zsh
cp -p $ZSH_CUSTOM/alias.zsh /media/Elements/oficina/copias_bashrc/alias_forbush.zsh     # por siaca
